 ...
 * @author Kernel
 */
public class JIFVisualizarProfessor extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jToggleButton1.setText("F6 - Recarregar");
        ...
        jLabel2.setText("Relatórios de Professores Cadastrados");
...
private void atalhos(){
    ...
    private void carregaTabelaUsuario() {
        try {
            populaTabelaUsuario((ArrayList<FuncionarioBean>) professorDao.listar());
        } catch (DaoException ex) {
            Logger.getLogger(JIFVisualizarProfessor.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

    private void populaTabelaUsuario(ArrayList<FuncionarioBean> listar) {
        JFVisualProfessorTableModel modeloFuncionario = new JFVisualProfessorTableModel(listar);
    ...
    private void filtrarUsuario() {
        ...
        try {
            populaTabelaUsuario((ArrayList<FuncionarioBean>) professorDao.pesquisarPorNome(chave));
        } catch (DaoException ex) {
            Logger.getLogger(JIFVisualizarProfessor.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
