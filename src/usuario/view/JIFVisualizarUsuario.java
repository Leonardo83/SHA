...
// * @author Kernel
// */
//public class JIFVisualizarUsuario extends javax.swing.JInternalFrame {
//
...
/*   @SuppressWarnings("unchecked")
    ...
    private void initComponents() {
        ...
        jToggleButton1.setText("F7 - Recarregar");
        ...
        jLabel2.setText("Relatórios de Usuários Cadastrados");
...
private void atalhos(){
    ...
    private void carregaTabelaUsuario() {
        try {
            populaTabelaUsuario((ArrayList<UsuarioBean>) usuarioDao.listar());
        } catch (DaoException ex) {
            Logger.getLogger(JIFVisualizarUsuario.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

    private void populaTabelaUsuario(ArrayList<UsuarioBean> listar) {
        JFVisualUsuarioTableModel modeloFuncionario = new JFVisualUsuarioTableModel(listar);
    ...
    private void filtrarUsuario() {
        ...
        try {
            populaTabelaUsuario((ArrayList<UsuarioBean>) usuarioDao.pesquisarPorNome(chave));
        } catch (DaoException ex) {
            Logger.getLogger(JIFVisualizarUsuario.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
